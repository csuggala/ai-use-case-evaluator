...

{
  ...
  "category1_risk_feasibility": {
    ...
    "regulatory_requirements": [
      {"regulation": "Name", "jurisdiction": "Jurisdiction", "triggered_by": "What triggered this", "requirement": "1 sentence on what must be done", "priority": "Must Have" | "Should Have" | "Monitor"}
    ],
...
- regulatory_requirements: list max 5 most important â€” only include frameworks that genuinely apply based on the use case details and company profile
